...
const input1 = document.getElementById("product_image1");
  ...
  if (!allowedExtensions.exec(input1.value)) {
    ...
    crop_btn.addEventListener("click", () => {
      ...
      cropper.getCroppedCanvas().toBlob((blob) => {
        ...
        let fileInputElement = document.getElementById("product_image1");
...
input2.addEventListener("change", () => {
  if (!allowedExtensions.exec(input2.value)) {
    ...
    // Creating a image tag inside imagebox which will hold the cropping view image(uploaded file) to it using the url created before.
    imagebox.innerHTML = `<img src="${url}" id="product_image1" style="width:100%;">`;

    // Storing that cropping view image in a variable
    const image = document.getElementById("product_image1");
